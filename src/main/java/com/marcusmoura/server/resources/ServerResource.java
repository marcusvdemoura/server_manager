package com.marcusmoura.server.resources;

import com.marcusmoura.server.enumeration.Status;
import com.marcusmoura.server.model.Response;
import com.marcusmoura.server.model.Server;
import com.marcusmoura.server.service.implementation.ServerServiceImplementation;
...
import static com.marcusmoura.server.enumeration.Status.*;
...
public class ServerResource {
    ...
    public byte[] getServerImage(@PathVariable("fileName") String fileName) throws IOException {
        return Files.readAllBytes(Paths.get(System.getProperty("user.home") + "/Downloads/images/"
        + fileName));
    }
}
